...
[![deno version](https://img.shields.io/badge/deno-^1.19.0-blue?logo=deno)](https://github.com/denoland/deno)
...
Rely on [oak@v10.1.0](https://deno.land/x/oak@v10.1.0/mod.ts) to simulate some
...
import {
  ...
  Res,
  UseGuards,
} from "https://deno.land/x/oak_nest@v1.5.2/mod.ts";
import type { CanActivate } from "https://deno.land/x/oak_nest@v1.5.2/mod.ts";
...
```ts
import { Injectable } from "https://deno.land/x/oak_nest@v1.5.2/mod.ts";
...
```ts
import { Factory } from "https://deno.land/x/oak_nest@v1.5.2/mod.ts";
...
import { Router } from "https://deno.land/x/oak_nest@v1.5.2/mod.ts";
...
```ts
import { Module } from "https://deno.land/x/oak_nest@v1.5.2/mod.ts";
...
```ts
import { Inject } from "https://deno.land/x/oak_nest@v1.5.2/mod.ts";
...
```ts
import { DynamicModule } from "https://deno.land/x/oak_nest@v1.5.2/mod.ts";
...
```ts
import { Inject, Injectable } from "https://deno.land/x/oak_nest@v1.5.2/mod.ts";
import { ASYNC_KEY } from "./async.constant.ts";
