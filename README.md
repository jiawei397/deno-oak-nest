...
```bash
deno run --allow-env --allow-run --allow-net --allow-read --allow-write --import-map https://deno.land/x/deno_nest@v3.1.3/cli/import_map.json https://deno.land/x/deno_nest@v3.1.3/cli/main.ts
```

Or you can install CLI by:

```bash
deno install --allow-env --allow-run --allow-net --allow-read --allow-write --import-map https://deno.land/x/deno_nest@v3.1.3/cli/import_map.json  -n nest -f https://deno.land/x/deno_nest@v3.1.3/cli/main.ts
```
...
"imports": {
  "@nest": "https://deno.land/x/deno_nest@v3.1.3/mod.ts",
  "@nest/hono": "https://deno.land/x/deno_nest@v3.1.3/modules/hono/mod.ts",
  "@nest/oak": "https://deno.land/x/deno_nest@v3.1.3/modules/oak/mod.ts",
