...
```bash
deno run --allow-env --allow-run --allow-net --allow-read --allow-write --import-map https://deno.land/x/deno_nest@v3.6.2/cli/import_map.json https://deno.land/x/deno_nest@v3.6.2/cli/main.ts
```

Or you can install CLI by:

```bash
deno install --allow-env --allow-run --allow-net --allow-read --allow-write --import-map https://deno.land/x/deno_nest@v3.6.2/cli/import_map.json  -n nest -f https://deno.land/x/deno_nest@v3.6.2/cli/main.ts
```
...
"imports": {
  ...
  "@nest/oak": "https://deno.land/x/deno_nest@v3.6.2/modules/oak/mod.ts",
  "@nest/tests": "https://deno.land/x/deno_nest@v3.6.2/tests/mod.ts",
...
[this way](https://deno.land/x/deno_nest@v3.6.2/modules/redis) or use the
