...
import { RedisModule } from "https://deno.land/x/oak_nest@v1.12.3/modules/redis/mod.ts";
...
```ts
import { RedisService } from "https://deno.land/x/oak_nest@v1.12.3/modules/redis/mod.ts";
