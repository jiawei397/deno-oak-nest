...
import { RedisModule } from "https://deno.land/x/oak_nest@v2.0.0/modules/redis/mod.ts";
...
```ts
import { RedisService } from "https://deno.land/x/oak_nest@v2.0.0/modules/redis/mod.ts";
