...
import { RedisModule } from "https://deno.land/x/oak_nest@v1.13.13/modules/redis/mod.ts";
...
```ts
import { RedisService } from "https://deno.land/x/oak_nest@v1.13.13/modules/redis/mod.ts";
