...
import { ElasticsearchModule } from "https://deno.land/x/deno_nest@v3.5.2/modules/elasticsearch/mod.ts";
...
```ts
import { ElasticsearchService } from "https://deno.land/x/deno_nest@v3.5.2/modules/elasticsearch/mod.ts";
