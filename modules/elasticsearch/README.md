...
import { ElasticsearchModule } from "https://deno.land/x/oak_nest@v1.13.19/modules/elasticsearch/mod.ts";
...
```ts
import { ElasticsearchService } from "https://deno.land/x/oak_nest@v1.13.19/modules/elasticsearch/mod.ts";
import { Controller, Get } from "https://deno.land/x/oak_nest@v1.13.19/mod.ts";
