...
{
  "imports": {
    "@nest": "https://deno.land/x/deno_nest@v3.9.1/mod.ts",
    "@nest/hono": "https://deno.land/x/deno_nest@v3.9.1/modules/hono/mod.ts",
    "@nest/elasticsearch": "https://deno.land/x/deno_nest@v3.9.1/modules/elasticsearch/mod.ts",
