...
import { ElasticsearchModule } from "https://deno.land/x/oak_nest/modules/elasticsearch/mod.ts";
...
```ts
import { ElasticsearchService } from "https://deno.land/x/oak_nest/modules/elasticsearch/mod.ts";
