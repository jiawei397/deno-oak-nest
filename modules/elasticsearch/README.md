...
import { ElasticsearchModule } from "https://deno.land/x/oak_nest@v1.13.17/modules/elasticsearch/mod.ts";
...
```ts
import { ElasticsearchService } from "https://deno.land/x/oak_nest@v1.13.17/modules/elasticsearch/mod.ts";
