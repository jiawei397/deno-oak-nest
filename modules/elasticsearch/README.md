...
import { ElasticsearchModule } from "https://deno.land/x/oak_nest@v1.8.4/modules/elasticsearch/mod.ts";
...
```ts
import { ElasticsearchService } from "https://deno.land/x/oak_nest@v1.8.4/modules/elasticsearch/mod.ts";
