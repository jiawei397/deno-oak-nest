...
import { CacheModule } from "https://deno.land/x/oak_nest@v1.10.1/modules/cache/mod.ts";
...
```ts
import { CacheInterceptor } from "https://deno.land/x/oak_nest@v1.10.1/modules/cache/mod.ts";
