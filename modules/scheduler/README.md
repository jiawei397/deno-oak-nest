...
import { CacheModule } from "https://deno.land/x/oak_nest@v2.0.0/modules/cache/mod.ts";
...
```ts
import { CacheInterceptor } from "https://deno.land/x/oak_nest@v2.0.0/modules/cache/mod.ts";
import { Controller, Get } from "https://deno.land/x/oak_nest@v2.0.0/mod.ts";
